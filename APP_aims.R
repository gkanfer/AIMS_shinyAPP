...
ui <- navbarPage("AIMS platform",
                 tabPanel("Image analysis",
                          sidebarLayout(
                            sidebarPanel(
                              ...
                              shinyjs::useShinyjs(),
                              id="side-panel",
                              actionButton("reset_input","Rest inputs"),
                              #textOutput(outputId = "file_name"),
                              #sliderInput("size","Image size:",1,1000,1,step=250),  ###chose whidt and hihgths
                              sliderInput("wh","threshold:",1,100,46,step=1),  ###chose whidt and hihgths
                              sliderInput("intensity", "choose Image intensity:",1,1000,21,step=1),
                              sliderInput("gm","gamma(clean noise):",0.0001,0.1,0.002,step=0.001),  ###chose whidt and hihgths
                              sliderInput("filter","matrix_size dapi (detect edges):",1,99,13,step=2),  ###chose whidt and hihgths
                              sliderInput("peri","Remove small objects:",1,500,30,step=1)  ###chose whidt and hihgths
                            ),
                            mainPanel(
                              tabsetPanel(
                          ...
                          sidebarLayout(
                            sidebarPanel(
                              ...
                              sliderInput("filter_GFP", "matrix_size GFP:",1,99,21,step=2),
                              sliderInput("wh_GFP","threshold GFP:",1,100,7,step=1),
                              sliderInput("gm_GFP","gamma_GFP",0.0001,0.1,0.012,step=0.001),  ###chose whidt and hihgths
                              sliderInput("global","global threshold GFP",0.1,20,0.2,step=0.1),  ###chose whidt and hihgths
                              sliderInput("peri_GFP","clean small objects",1,1000,50,step=5),  ###chose whidt and hihgths
                            ...
                            mainPanel(
                              ...
                              # p("the first channle should be the segmentation channle (e.g. Dapi),"),
                              # p("the scond chanalle should be the target channle")
                 ...
                 tabPanel("Classification of postive objects",
                          fluidRow(style = "margin: 15px;",
                                   column(12,
                                          h4("Choose cells"),
                                          sliderInput("intensity_classification", "choose segmented image intensity:",0.1,500,1,step=0.1),
                 ...
                 tabPanel("Classification of negative objects",
                          fluidRow(style = "margin: 15px;",
                                   column(12,
                                          h4("Choose cells"),
                                          sliderInput("intensity_classification.negtive", "choose segmented image intensity:",0.1,500,1,step=0.1),
                 ...
                 tabPanel("Create a model",
                          ...
                          fluidRow(style = "margin: 15px;",
                                   column(6,
                                          h3("number of postive class cells observed"),
                                          div(id = "postive_number", style = "min-height: 600px;",textOutput("postive_number"))),
                                   column(6,
                                          h3("number of negative class cells observed"),
                 ...
                 tabPanel("test model",
                          sidebarLayout(
                            sidebarPanel(
                              ...
                              fileInput("image_new", "load image for testing model"),
                              sliderInput("dv","SVM decision value",-5,5,0,step=0.1),
                              sliderInput("test_intensity", "choose test image intensity:",1,1000,1,step=1)),
                 ...
                 tabPanel("test model re-classification",
                          sidebarLayout(
                            sidebarPanel(
                              ...
                              h4("Choose cells"),
                              sliderInput("intensity_classification_1", "choose segmented image intensity:",0.1,500,1,step=0.1),
